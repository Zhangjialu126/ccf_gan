...
def prepare_parser():
    ...
    parser.add_argument('--t_dim', type=int, default=512, help='Dimension of output tx (default: %(default)s)')
    parser.add_argument('--tx_lambda', type=float, default=math.pi / 2,
                        help='tx task lambda coefficient for tx (default: %(default)s)')
    parser.add_argument('--ty_lambda', type=float, default=10.0,
                        help='ty task lambda coefficient for ty (default: %(default)s)')
